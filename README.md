...
## Custom Datasets
We trained our model on COCO person data set. You can also train on your own dataset by following these steps:
...
# Training
By default, we train on COCO person data set. 
